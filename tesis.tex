...
%\usepackage[utf8]{inputenc}	% Codificación estándar en inglés
\usepackage{newlfont}
...
\afterpreface
% ---------------------------------------------------------------------------------------------------------------
\include{tex/01-introduccion}
\include{tex/02-estado_del_arte}
\include{tex/03-herramientas_actuales}
\include{tex/04-analisis_comparativo}
\include{tex/05-implementacion}
\include{tex/06-conclusiones}
\appendix
\include{tex/07-apendice.a}
% ---------------------------------------------------------------------------------------------------------------
\singlespacing
